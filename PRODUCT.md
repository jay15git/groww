...
Delegated: responsive React prototype optimized for mobile, with desktop presentation framing and public no-login deployment.

## Users

Indian investors aged 20–26 who are opening or considering their first investment account. Their financial context varies across students with pocket money, interns, salaried first-jobbers, freelancers, creators, gig workers, mixed-income earners, and young adults with family obligations. They vary in disposable surplus, emergency readiness, language, market knowledge, risk tolerance, living arrangement, and exposure to social-media financial content.

The prototype must visibly demonstrate adaptation across three representative contexts: student, salaried, and freelancer.
...
The assignment is a product-management take-home evaluated through a 300–700 word thought-process page, prompts, evals, and a publicly accessible app. The prototype uses mocked data and deterministic AI demonstrations. It must work without authentication and make its assumptions explicit.
...
7. Money Trail explains settlement.
...
Commercial uplift claims, user testimonials, and prototype performance metrics must not be fabricated.

## Product Principles

1. Make internet curiosity safer without making it boring.
2. Personalize by financial context, not age stereotype.
3. Show consequences before confirmation and status after it.
4. Gamify learning, planning, and consistency; never trading frequency.
5. Let AI explain and challenge while the user remains in control.
6. Make one core journey unforgettable before expanding feature breadth.

## Accessibility & Inclusion

Target WCAG 2.2 AA for the web prototype. Use 44px minimum touch targets, visible focus states, semantic controls, adequate contrast, reduced-motion support, text alternatives, non-color status cues, responsive behavior from 320px upward, and readable financial numbers. Localization must preserve financial meaning rather than translate slang literally.
